  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    var raisedButton = ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        disabledBackgroundColor: map.containsKey('disabledColor')
            ? parseHexColor(map['disabledColor'])
            : null,
        disabledForegroundColor: map.containsKey('disabledTextColor')
        ...
        padding: map.containsKey('padding')
            ...
            : null,
        surfaceTintColor: map.containsKey('splashColor')
            ? parseHexColor(map['splashColor'])
            : null,
        foregroundColor: map.containsKey('textColor')
    ...
    return <String, dynamic>{
      ...
      "color": realWidget.style?.backgroundColor != null
          ? realWidget.style?.backgroundColor!
              ...
              .toRadixString(16)
          : null,
      "disabledColor": realWidget.style?.backgroundColor != null
          ? realWidget.style?.backgroundColor!
              .resolve({MaterialState.disabled})
              ?.value
              .toRadixString(16)
          : null,
      "elevation": realWidget.style?.elevation,
      "padding": padding != null
          ? "${padding.left},${padding.top},${padding.right},${padding.bottom}"
          : null,
      "splashColor": realWidget.style?.surfaceTintColor != null
          ? realWidget.style?.surfaceTintColor
              ?.resolve({MaterialState.focused})
              ?.value
              .toRadixString(16)
          : null,
      "textColor": realWidget.style?.foregroundColor != null
